...
ggplot(call_day, aes(x=factor(dayofweek), y=count)) + stat_summary(fun.y="mean", geom="bar") + ggtitle("Average Calls per Day by Day of Week")+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black")) + xlab("Day of Week") + ylab("Number of Calls per Day") + scale_x_discrete(labels=c("1" = "Sunday", "2" = "Monday", "3" = "Tuesday", "4" = "Wednesday", "5" = "Thursday", "6" = "Friday", "7" = "Saturday"))
